...
const eventType = '0x163df34fccbf003ce219d3f1d9e70d140b60622cb9dd47599c25fb2f797ba6e::liquidity_pool::SwapEvent'
...
export class EventProcessor extends TransactionsProcessor {
  ...
  processTransactions({
    ...
    for (const transaction of transactions) {
      ...
      const filteredEvents = events.filter(value => value.typeStr?.includes(eventType))
